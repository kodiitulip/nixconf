{ inputs, ... }:
{
  perSystem =
    { pkgs, ... }:
    {
      packages.zen = inputs.wrappers.lib.wrapPackage {
        inherit pkgs;
        package =
          pkgs.wrapFirefox
              ...
              extraPolicies = {
                ...
                SearchEngines = {
                  ...
                  Add = [
                    ...
                    {
                      Name = "HjemRum options";
                      URLTemplate = "https://snugnug.github.io/hjem-rum/search.html?q={searchTerms}";
                      IconURL = "https://snugnug.github.io/favicon.ico";
                      Alias = "@hr";
                    }
                    {
                      Name = "Noogle";
