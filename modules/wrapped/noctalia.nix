  ...
  flake.wrapperModules.noctalia-shell = _: {
    config = {
      colors = {
        ...
        mTertiary = self.theme.base09;
        mOnTertiary = self.theme.base05;
        mError = self.theme.base06;
      ...
      settings = {
        ...
        bar = {
          ...
          widgets = {
            ...
            right = [
              ...
              {
                customFont = "";
                formatHorizontal = "HH:mm, dd ddd MMM";
        ...
        notifications = {
          ...
          sounds = {
            criticalSoundFile = "";
            enabled = false;
            excludedApps = "discord,firefox,chrome,chromium,edge,zen";
            lowSoundFile = "";
            normalSoundFile = "";
